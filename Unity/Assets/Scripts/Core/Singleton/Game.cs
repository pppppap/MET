...
namespace ET
{
    public static class Game
    {
        ...
        // 正式环境
        public static bool IsProduct => Options.Instance.Develop == 0;

        // 开发环境
        public static bool IsDevelop => Options.Instance.Develop == 1;

        // 压测环境
        public static bool IsBenchmark => Options.Instance.Develop == 2;
